...
(test with-graphene-quad.2
  (graphene:with-graphene-quads (p1 p2 p3 p4)
...
(test quad-init-from-points
  (graphene:with-graphene-points (p0 p1 p2 p3)
    (graphene:with-graphene-quad (q)
      (is (cffi:pointer-eq q (graphene:quad-init-from-points q (list p0 p1 p2 p3)))))))

;;;     graphene_quad_contains

(test quad-contains
  (graphene:with-graphene-points ((p0 1 2) (p1 4 2) (p2 4 6) (p3 1 6) (pt1 3 4) (pt2 3 10))
