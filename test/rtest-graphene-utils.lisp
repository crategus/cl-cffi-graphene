...
(test graphene-with-object-point.5
...
(test graphene-with-objects-points.2
  (graphene:with-objects ((p1 graphene:point-t)
...
(test graphene-with-objects-points.3
  (graphene:with-objects ((v graphene:vec2-t 1.5 2.5)
